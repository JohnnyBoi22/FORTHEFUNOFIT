...
def diamond_room():
  # some prompts
  print("\nYou are now in a room filled with waifus!")
  print("And there is a door too!")
  print("What would you do? (1 or 2)")
  print("1). Bang all the sexy waifus.")
  ...
  if answer == "1":
    ...
    game_over("You contracted STDS and died!")
  elif answer == "2":
...
def bear_room():
  ...
  if answer == "1":
    ...
    print("\nYour taunts scared the bear so the bear moved from the door. You can go through it now!")
    diamond_room()
  else:
...
def monster_room():
  # some prompts
  # '\n' is to print the line in a new line
  print("\nNow you entered the room of a pedo!")
  print("The pedo is sleeping.\nBehind the pedo, there is another door. What would you do? (1 or 2)")
  print("1). Go through the door silently.")
  print("2). Kill the pedo and show your courage!")
  ...
  if answer == "1":
    ...
    game_over("The pedo was horny, he banged you.")
  else:
